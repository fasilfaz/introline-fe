          ...
          <div className="border-b border-gray-200 px-8 py-6">
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-800">Introlines </h1>
                  <p className="text-gray-600 text-sm">No.25(2)/22, Ground Floor,, Opp Vinayakar Kovil, Kumarapuram 1st Street Ryapuram,</p>
                </div>
              </div>
