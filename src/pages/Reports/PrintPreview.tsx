  ...
  const handleSimplePrint = () => {
      ...
      const printContent = `
        ...
        return `
              <div class="page">
                ...
                <div class="footer">
                  <p>${reportConfigs['purchase-order']?.report_footer || 'Generated by Introlines '}</p>
                </div>
              </div>
            `;
      }).join('')}
      ...
      const printContent = `
        ...
        <html>
          ...
          <body>
             ...
             <div class="footer">
                ${reportConfigs['sales']?.report_footer || 'Generated by Introlines '}
             </div>
          </body>
        </html>
      `;
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          <p>${reportConfigs['stock']?.report_footer || 'Generated on ' + new Date().toLocaleDateString() + ' by Introlines '}</p>
        </div>
      </body>
    </html>
  `;
      ...
      const printContent = `
        ...
        <html>
          ...
          : 'All Time'}</p>
            ...
            <div class="footer">
              <p>Generated on ${formatDate(new Date())} by Introlines </p>
            </div>
          </body>
        </html>
      `;
        ...
        {selectedReportType === 'purchase-order' ? (
          ...
          <div className="bg-white rounded-lg shadow-lg border border-gray-200">
            <div className="min-h-[29.7cm] p-8">
              ...
              <div className="mt-12 border-t pt-8">
                <div className="text-center text-gray-500 text-xs">
                  <p>{reportConfigs['sales']?.report_footer || `Generated on ${formatDate(new Date())} by Introlines `}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg border border-gray-200">
            <div className="min-h-[29.7cm] p-8">
              ...
              <div className="mt-12 border-t pt-8">
                <div className="text-center text-gray-500 text-xs">
                  <p>{reportConfigs['stock']?.report_footer || `Generated on ${formatDate(new Date())} by Introlines `}</p>
                </div>
              </div>
            </div>
          </div>
