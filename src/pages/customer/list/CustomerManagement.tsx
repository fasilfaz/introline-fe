...
const CUSTOMER_TYPE_OPTIONS: Array<{ value: 'Sender' | 'Receiver'; label: string }> = [
...
type SortField = 'name' | 'phone' | 'shopName' | 'status' | 'createdAt' | 'credit' | 'customerType';
...
export const CustomerManagement: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const customerTypeFilterChanged = prevCustomerTypeFilter.current !== customerTypeFilter;
    ...
    if (searchChanged || statusFilterChanged || customerTypeFilterChanged) {
      setCurrentPage(1);
                  ...
                  <TableHeader>
                    <TableRow className="hover:bg-gray-50 border-gray-200">
                      <TableHead className="font-semibold">
                        ...
                        >
                          Type
                          <SortIndicator column="customerType" sortConfig={sortConfig} />
                        </button>
                      </TableHead>
                      <TableHead className="font-semibold">
                        <button
                      ...
                      <TableHead className="font-semibold">
                        ...
                        >
                          ...
                          Shop Name
                          <SortIndicator column="shopName" sortConfig={sortConfig} />
                        </button>
                      </TableHead>
                      <TableHead className="font-semibold">
                        <button
                      ...
                      <TableHead className="font-semibold">
                        ...
                        >
                          ...
                          Credit
                          <SortIndicator column="credit" sortConfig={sortConfig} />
                        </button>
                      </TableHead>
                      <TableHead className="font-semibold">
                        <button
