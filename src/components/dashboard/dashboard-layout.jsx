...
import { Menu, X, Users, LayoutTemplate, ChevronRight, Bell, LogOut, BadgeDollarSign, ChartNoAxesCombined, Store, Boxes, Wallet, MapPin, UserCheck, DollarSign, Calendar, Container, ClipboardList, PackageCheck, Receipt } from 'lucide-react';
...
export const DashboardLayout = () => {
  ...
  const allMenuItems = [
    ...
    },
    {
      ...
      icon: <MapPin className="mr-3 h-4 w-4 flex-shrink-0" />,
    ...
    {
      path: '/dashboard/price-listings',
      label: 'Price Listings',
      icon: <DollarSign className="mr-3 h-4 w-4 flex-shrink-0" />,
      roles: ['superadmin', 'admin', 'biller']
    },
    {
    ...
    },
    {
      ...
      label: 'Bills',
      icon: <Receipt className="mr-3 h-4 w-4 flex-shrink-0" />,
      roles: ['superadmin', 'admin', 'biller']
    },
    // {
    //   label: 'Reports',
    ...
    // },
    {
      ...
      label: 'Reports',
      icon: <ChartNoAxesCombined className="mr-3 h-4 w-4 flex-shrink-0" />,
      roles: ['superadmin', 'admin', 'telecaller', 'pickup-boy', 'marketing-executive', 'store-keeper', 'manager', 'customer', 'logistic-coordinator']
    },
  ];
